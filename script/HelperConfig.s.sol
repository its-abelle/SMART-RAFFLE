...
contract HelperConfig is CodeConstants, Script {
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        // For local testing, we use a fixed subscription ID
        // Note: The mock's createSubscription has a bug, so we avoid calling it
        localNetworkConfig = NetworkConfig({
            subscriptionId: 0, // Set to 0 to skip creation logic
